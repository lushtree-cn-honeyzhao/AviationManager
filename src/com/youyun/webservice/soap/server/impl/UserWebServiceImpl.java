 ...
 */
package com.youyun.webservice.soap.server.impl;
...
@WebService(serviceName = "UserService", portName = "UserServicePort", endpointInterface = "com.youyun.webservice.ws.server.UserWebService", targetNamespace = WsConstants.NS)
