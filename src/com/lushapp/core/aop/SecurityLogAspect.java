...
import com.lushapp.core.security.SecurityType;
...
public class SecurityLogAspect {
     ...
     * @param joinPoint 切入点
     */
    @After("execution(* com.lushapp.modules.sys.web.LoginController.login(..))")
     ...
     * @param joinPoint 切入点
     */
    @Before("execution(* com.lushapp.modules.sys.web.LoginController.logout(..))")
