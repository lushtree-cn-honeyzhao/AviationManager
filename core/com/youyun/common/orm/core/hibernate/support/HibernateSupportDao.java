...
import com.youyun.common.orm.core.Page;
import com.youyun.common.orm.core.PageRequest;
import com.youyun.common.orm.core.PropertyFilter;
import com.youyun.common.orm.core.RestrictionNames;
import com.youyun.common.orm.core.hibernate.HibernateRestrictionBuilder;
...
public class HibernateSupportDao<T,ID extends Serializable> extends BasicHibernateDao<T, ID>{
	 ...
	 * @param propertyName orm实体属性名称
	 * @param value 值
	 * @param restrictionName 约束名称,参考{@link com.youyun.common.orm.core.hibernate.CriterionBuilder}的实现类
	 *
	 * @return List
	 */
	 ...
	 * @param propertyName 属性名称
	 * @param value 值
	 * @param restrictionName 约束名称 参考{@link com.youyun.common.orm.core.hibernate.CriterionBuilder}的所有实现类
	 *
	 * @return Object
	 */
