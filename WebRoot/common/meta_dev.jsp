...
%>
<%-- jQuery Cookie插件 --%>
<script type="text/javascript" src="${ctxStatic}/js/jquery/jquery.cookie.js" charset="utf-8"></script>
...
<script type="text/javascript" src="${ctxStatic}/js/jquery/easyui-${ev}/jquery.easyui.my97.js" charset="utf-8"></script>
...
<%-- easyui扩展 --%>
<script type="text/javascript" src="${ctxStatic}/js/easyui-extend.js" charset="utf-8"></script>
<!-- 屏蔽键盘等事件 -->
<%-- 
<script type="text/javascript" src="${ctxStatic}/js/prohibit.js" charset="utf-8"></script>
--%>
<%-- easyui自定义表单校验扩展 --%>
<script type="text/javascript" src="${ctxStatic}/js/validatebox-extend.js" charset="utf-8"></script>
<%-- easyui后台异步校验 --%>
<script type="text/javascript" src="${ctxStatic}/js/validatebox-ajax.js" charset="utf-8"></script>
